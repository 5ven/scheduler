          ...
          <div class="container">
            <div class="row">
              <div class="col-md-10 col-lg-10 col-sm-12">
                ...
                <p>Business ("us", "we", or "our") operates the https://businessnamehere.org website (hereinafter referred to as the "Service").</p>

                <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy for Business is based on the <a href="https://privacypolicies.com/blog/privacy-policy-template/">Privacy Policy Template from Privacy Policies</a>.</p>

                <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from https://businessnamehere.org</p>
                ...
                <p>Business uses the collected data for various purposes:</p>
                <ul>
                ...
                <p>Business may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                <ul>
                    <li>To comply with a legal obligation</li>
                    <li>To protect and defend the rights or property of Business</li>
                ...
                <ul>
                    <li>By visiting this page on our website: https://businessnamehere.org</li>
                </ul>
              </div>
            </div>
          </div>
...
export default {
  components: { UAnimateContainer, UAnimate, Menu }
}
</script>
